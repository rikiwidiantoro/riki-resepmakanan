...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-dark shadow-sm" style="background-color: rgb(84,119,148)">
            <div class="container">
                <a class="navbar-brand" style="font-size: 22px;" href="{{ url('/') }}">
                    {{ config('app_name', 'Resepku') }}
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @guest
                            ...
                            @endif
                        @else
                            <a class="nav-link mx-3" href="/tulisresep/{{ Auth::user()->id }}" style="color: white">Tulis Resep</a>
        ...
        <br><br>
        <footer class="text-center py-2 text-light" style="background-color: rgb(84,119,148);">
            <p>Make by Riki Widiantoro | Ponorogo</p>
        </footer>
    </div>
